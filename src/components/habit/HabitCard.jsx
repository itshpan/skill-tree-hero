...
const categoryColors = {
  ...
  discipline: { bg: 'bg-amber-700', border: 'border-amber-600', text: 'text-white', glow: '#D97706' },
  ...
  charisma: { bg: 'bg-cyan-500', border: 'border-cyan-400', text: 'text-white', glow: '#00FFFF' }
};
